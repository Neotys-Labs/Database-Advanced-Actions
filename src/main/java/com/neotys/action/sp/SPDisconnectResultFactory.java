...
import static com.neotys.action.sp.SPDisconnectXmlResultWriter.generateXMLOutput;

import javax.xml.parsers.ParserConfigurationException;
import javax.xml.transform.TransformerException;

import com.google.common.collect.Multimap;
import com.neotys.action.sp.SPDisconnectXmlResultWriter.State;
...
final class SPDisconnectResultFactory {
	 ...
	 * @return
	 */
	static SampleResult newDisconnectionResult(final Context context) {
		return newResult(context, false, STATUS_CODE_OK, "The SQL Connection was closed successfully.", null, null,
				false);
	}
	...
	private static SampleResult newResult(final Context context, final boolean isError, final String statusCode,
		...
		context.getLogger().debug("SQL disconnect action execution finished with status code: " + statusCode + 
				" (" + statusMessage + ")");
